...
export async function GET() {
    const data = {
        extras: {
            ...
            description: "Cerez Politikası",
            keywords: "Cerez Politikası",
            breadcrumb: {
                items: [
                    {
                        name: "Anasayfa",
            ...
            url: {
                ...
                href: "https://www.bloomberghtradyo.com/cerez-politikasi",
                origin: "https://www.bloomberghtradyo.com",
                pathname: "/cerez-politikasi",
                port: "",
                protocol: "https",
                url: "https://www.bloomberghtradyo.com/cerez-politikasi",
            },
            tracking: {
            ...
            content: [
                {
                    ...
                    "type": "header",
                    "data": {
                        "text": "Kişisel Verilerinizin İşlenmesi ve Korunması",
                        "level": 1
                    }
                },
                {
